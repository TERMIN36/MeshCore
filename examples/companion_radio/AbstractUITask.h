...
public:
  ...
  // The phone took a message that was also kept on the device screen.
  virtual void clearTakenMsg() {}
  virtual void newMsg(uint8_t path_len, const char* from_name, const char* text, int msgcount, bool group) = 0;
